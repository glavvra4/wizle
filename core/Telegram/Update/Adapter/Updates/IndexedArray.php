...
namespace Core\Telegram\Update\Adapter\Updates;

use Core\Common\Adapter\BaseIndexedArray;
use Core\Telegram\Update\Adapter\Update\AssociativeArray as UpdateAssociativeArrayAdapter;
...
class IndexedArray extends BaseIndexedArray implements UpdatesInterface
{
    ...
    public function __construct(array $data)
    {
        foreach ($data as $datum) {
            ...
            $this->container[] = new UpdateAssociativeArrayAdapter($datum);
        }
