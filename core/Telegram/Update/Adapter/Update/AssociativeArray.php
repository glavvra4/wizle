...
namespace Core\Telegram\Update\Adapter\Update;
    ...
    public function __construct(array $data)
    {
        ...
        $this->update = new Update(
            ...
            (array_key_exists('message', $data) && $data['message'] !== null)
                ? new MessageAssociativeArrayAdapter($data['message'])
                : null,
            (array_key_exists('edited_message', $data) && $data['edited_message'] !== null)
                ? new MessageAssociativeArrayAdapter($data['edited_message'])
                : null,
            (array_key_exists('channel_post', $data) && $data['channel_post'] !== null)
                ? new MessageAssociativeArrayAdapter($data['channel_post'])
                : null,
            (array_key_exists('edited_channel_post', $data) && $data['edited_channel_post'] !== null)
                ? new MessageAssociativeArrayAdapter($data['edited_channel_post'])
                : null,
        );
    }
