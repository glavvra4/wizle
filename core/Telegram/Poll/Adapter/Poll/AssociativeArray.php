...
namespace Core\Telegram\Poll\Adapter\Poll;

use Core\Common\Adapter\BaseAssociativeArray;
use Core\Telegram\Message\Adapter\MessageEntities\IndexedArray as MessageEntitiesIndexedArrayAdapter;
use Core\Telegram\Message\Entity\MessageEntitiesInterface;
use Core\Telegram\Poll\Adapter\PollOptions\IndexedArray as PollOptionsIndexedArrayAdapter;
...
class AssociativeArray extends BaseAssociativeArray implements PollInterface
{
    ...
    public function __construct(array $data)
    {
        ...
        $this->poll = new Poll(
            ...
            new PollOptionsIndexedArrayAdapter($data['options']),
            ...
            (array_key_exists('explanation_entities', $data) && $data['explanation_entities'] !== null)
                ? new MessageEntitiesIndexedArrayAdapter($data['explanation_entities'])
                : null,
