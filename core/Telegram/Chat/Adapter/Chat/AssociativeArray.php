...
namespace Core\Telegram\Chat\Adapter\Chat;

use Core\Common\Adapter\BaseAssociativeArray;
use Core\Telegram\Chat\Adapter\ChatLocation\AssociativeArray as ChatLocationAssociativeArrayAdapter;
use Core\Telegram\Chat\Adapter\ChatPermissions\AssociativeArray as ChatPermissionsAssociativeArrayAdapter;
use Core\Telegram\Chat\Adapter\Usernames\IndexedArray as ChatUsernamesIndexedArrayAdapter;
...
use Core\Telegram\File\Adapter\ChatPhoto\AssociativeArray as ChatPhotoAssociativeArrayAdapter;
use Core\Telegram\File\Entity\ChatPhotoInterface;
use Core\Telegram\Message\Entity\MessageInterface;
use Core\Telegram\Message\Adapter\Message\AssociativeArray as MessageAssociativeArrayAdapter;
    ...
    public function __construct(array $data)
    {
        ...
        $this->chat = new Chat(
            ...
            (array_key_exists('photo', $data) && $data['photo'] !== null)
                ? new ChatPhotoAssociativeArrayAdapter($data['photo'])
                : null,
            (array_key_exists('active_usernames', $data) && $data['active_usernames'] !== null)
                ? new ChatUsernamesIndexedArrayAdapter($data['active_usernames'])
                : null,
            ...
            (array_key_exists('pinned_message', $data) && $data['pinned_message'] !== null)
                ? new MessageAssociativeArrayAdapter($data['pinned_message'])
                : null,
            (array_key_exists('permissions', $data) && $data['bio'] !== null)
                ? new ChatPermissionsAssociativeArrayAdapter($data['bio'])
                : null,
            ...
            (array_key_exists('location', $data) && $data['location'] !== null)
                ? new ChatLocationAssociativeArrayAdapter($data['location'])
                : null,
        );
    }
